...
# --- Configuration ---
INPUT_CSV_PATH = '../data/copper_train_2501.csv'
OUTPUT_CSV_PATH = '../data/pre_metal_t15_T25_I0.1_10.csv'
...
if __name__ == "__main__":
    # 設置輸入和輸出路徑
    # ../data/Metal_t15_T25_I0.1_10.csv
    csv_file = "../data/copper_train_2501.csv"
    output_dir = "../output"
